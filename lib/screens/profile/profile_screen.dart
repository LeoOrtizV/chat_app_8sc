...
class _ProfileScreenState extends State<ProfileScreen> {
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Column(children: [_buildProfilePicture(),
                if(_isEditMode) ... [
                  SizedBox(height: 12),
                  CusomSmallButton(
                    text: 'Change Photo', 
              ...
              Padding(padding: EdgeInsets.all(AppConstants.paddingLarge),
              child: Form(
                key: _formKey,
                child: Column(
  ...
  Widget _buildProfilePicture(){
    ...
    if (_selectedImage != null){
      ...
      imageWidget = CachedNetworkImage(imageUrl: _currentUser!.photoUrl!,
      fit: BoxFit.cover,
